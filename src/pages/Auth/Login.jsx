...
const Login = () => {
    ...
    return (
        <div className="container">
            <Box sx={{display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: 5, borderRadius: '4px', padding: '50px 30px', backgroundColor: 'white'}}>
                <form onSubmit={handleLogin}>
                    ...
                    <Typography className="typo-dont-have">Don't have an account?{' '}
